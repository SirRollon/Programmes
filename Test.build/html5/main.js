...
c_MyApp.m_new=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<18>";
...
c_MyApp.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<31>";
	bb_app_SetUpdateRate(60);
	err_info="C:/Dropbox/Programmes/Test.monkey<34>";
	this.m_start=c_Bouton.m_new.call(new c_Bouton);
	err_info="C:/Dropbox/Programmes/Test.monkey<35>";
	dbg_object(this.m_start).m_x=150;
	err_info="C:/Dropbox/Programmes/Test.monkey<36>";
	dbg_object(this.m_start).m_y=150;
	err_info="C:/Dropbox/Programmes/Test.monkey<37>";
	this.m_start.p_OnCreate();
	err_info="C:/Dropbox/Programmes/Test.monkey<40>";
	this.m_score=c_Affichage.m_new.call(new c_Affichage);
	err_info="C:/Dropbox/Programmes/Test.monkey<41>";
	dbg_object(this.m_score).m_x=300;
	err_info="C:/Dropbox/Programmes/Test.monkey<42>";
	dbg_object(this.m_score).m_y=300;
	err_info="C:/Dropbox/Programmes/Test.monkey<43>";
	this.m_score.p_OnCreate();
	err_info="C:/Dropbox/Programmes/Test.monkey<44>";
	dbg_object(this.m_score).m_texte="SCORE";
	err_info="C:/Dropbox/Programmes/Test.monkey<45>";
	dbg_object(this.m_score).m_infobulle=true;
	err_info="C:/Dropbox/Programmes/Test.monkey<48>";
	this.m_information=c_Affichage.m_new.call(new c_Affichage);
	err_info="C:/Dropbox/Programmes/Test.monkey<49>";
	dbg_object(this.m_information).m_x=0;
	err_info="C:/Dropbox/Programmes/Test.monkey<50>";
	dbg_object(this.m_information).m_y=0;
	err_info="C:/Dropbox/Programmes/Test.monkey<51>";
	this.m_information.p_OnCreate();
	err_info="C:/Dropbox/Programmes/Test.monkey<52>";
	dbg_object(this.m_information).m_texte=bb_Test_txtinformation;
	err_info="C:/Dropbox/Programmes/Test.monkey<55>";
	this.m_fond=bb_graphics_LoadImage("galaxie.jpg",1,c_Image.m_DefaultFlags);
	err_info="C:/Dropbox/Programmes/Test.monkey<56>";
	this.m_fond2=bb_graphics_LoadImage("bureau.jpg",1,c_Image.m_DefaultFlags);
	err_info="C:/Dropbox/Programmes/Test.monkey<59>";
	this.m_texte1=c_AngelFontExample.m_new.call(new c_AngelFontExample);
	err_info="C:/Dropbox/Programmes/Test.monkey<60>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<65>";
	this.m_start.p_OnUpdate();
	err_info="C:/Dropbox/Programmes/Test.monkey<66>";
	this.m_score.p_OnUpdate();
	err_info="C:/Dropbox/Programmes/Test.monkey<67>";
	dbg_object(this.m_information).m_texte=bb_Test_txtinformation;
	err_info="C:/Dropbox/Programmes/Test.monkey<68>";
	this.m_information.p_OnUpdate();
	err_info="C:/Dropbox/Programmes/Test.monkey<70>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<76>";
	bb_graphics_Cls(0.0,0.0,0.0);
	err_info="C:/Dropbox/Programmes/Test.monkey<77>";
	if(bb_Test_numeroDuFond==1){
		err_info="C:/Dropbox/Programmes/Test.monkey<78>";
		bb_graphics_DrawImage(this.m_fond,0.0,0.0,0);
	}
	err_info="C:/Dropbox/Programmes/Test.monkey<81>";
	if(bb_Test_numeroDuFond==2){
		err_info="C:/Dropbox/Programmes/Test.monkey<82>";
		bb_graphics_DrawImage(this.m_fond2,0.0,0.0,0);
	}
	err_info="C:/Dropbox/Programmes/Test.monkey<85>";
	this.m_start.p_OnRender();
	err_info="C:/Dropbox/Programmes/Test.monkey<86>";
	this.m_score.p_OnRender();
	err_info="C:/Dropbox/Programmes/Test.monkey<87>";
	this.m_information.p_OnRender();
	err_info="C:/Dropbox/Programmes/Test.monkey<89>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnLoading=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<94>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnSuspend=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<106>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnResume=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<111>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnClose=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<116>";
	c_App.prototype.p_OnClose.call(this);
	err_info="C:/Dropbox/Programmes/Test.monkey<117>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnBack=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<122>";
	c_App.prototype.p_OnBack.call(this);
	err_info="C:/Dropbox/Programmes/Test.monkey<123>";
	pop_err();
	return 0;
}
...
var bb_Test_theApp=null;
function bbMain(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<12>";
	bb_Test_theApp=c_MyApp.m_new.call(new c_MyApp);
	err_info="C:/Dropbox/Programmes/Test.monkey<13>";
	pop_err();
	return 0;
}
...
c_Bouton.m_new=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<159>";
	pop_err();
	return this;
}
c_Bouton.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<169>";
	this.m_bouton=bb_graphics_LoadImage("bouton.png",1,c_Image.m_DefaultFlags);
	err_info="C:/Dropbox/Programmes/Test.monkey<171>";
	pop_err();
	return 0;
}
c_Bouton.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<177>";
	var t_hit=bb_input_KeyHit(1);
	err_info="C:/Dropbox/Programmes/Test.monkey<179>";
	if(t_hit==1){
		err_info="C:/Dropbox/Programmes/Test.monkey<180>";
		print("X ="+String(this.m_x)+"Y="+String(this.m_y));
	}
	err_info="C:/Dropbox/Programmes/Test.monkey<183>";
	if(((t_hit)!=0) && bb_input_MouseY()>(this.m_y) && bb_input_MouseY()<(this.m_y+this.m_hauteur) && bb_input_MouseX()>(this.m_x) && bb_input_MouseX()<(this.m_x+this.m_largeur)){
		err_info="C:/Dropbox/Programmes/Test.monkey<184>";
		print("clic sur le bouton"+bb_Test_txtinformation);
		err_info="C:/Dropbox/Programmes/Test.monkey<185>";
		bb_Test_txtinformation="clic sur le bouton";
		err_info="C:/Dropbox/Programmes/Test.monkey<187>";
		bb_Test_numeroDuFond=1;
		err_info="C:/Dropbox/Programmes/Test.monkey<190>";
		print("numeroDuFond = "+String(bb_Test_numeroDuFond));
	}
	err_info="C:/Dropbox/Programmes/Test.monkey<192>";
	pop_err();
	return 0;
}
c_Bouton.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<198>";
	bb_graphics_DrawImage(this.m_bouton,(this.m_x+((this.m_largeur/2)|0)),(this.m_y+((this.m_hauteur/2)|0)),0);
	err_info="C:/Dropbox/Programmes/Test.monkey<200>";
	pop_err();
	return 0;
}
...
c_Affichage.m_new=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<204>";
	pop_err();
	return this;
}
c_Affichage.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<214>";
	pop_err();
	return 0;
}
c_Affichage.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<219>";
	if(this.m_infobulle){
		err_info="C:/Dropbox/Programmes/Test.monkey<221>";
		if(bb_input_MouseY()>(this.m_y) && bb_input_MouseY()<(this.m_y+this.m_hauteur) && bb_input_MouseX()>(this.m_x) && bb_input_MouseX()<(this.m_x+this.m_largeur)){
			err_info="C:/Dropbox/Programmes/Test.monkey<222>";
			bb_Test_txtinformation="survol du score, afficher des infos";
			err_info="C:/Dropbox/Programmes/Test.monkey<223>";
			print("survol");
			err_info="C:/Dropbox/Programmes/Test.monkey<224>";
			this.m_survol=true;
			err_info="C:/Dropbox/Programmes/Test.monkey<225>";
			bb_Test_numeroDuFond=2;
		}
	}
	err_info="C:/Dropbox/Programmes/Test.monkey<228>";
	pop_err();
	return 0;
}
c_Affichage.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<233>";
	bb_graphics_SetColor(255.0,255.0,0.0);
	err_info="C:/Dropbox/Programmes/Test.monkey<234>";
	bb_graphics_DrawRect((this.m_x),(this.m_y),(this.m_largeur),(this.m_hauteur));
	err_info="C:/Dropbox/Programmes/Test.monkey<235>";
	bb_graphics_DrawText(this.m_texte,(this.m_x+((this.m_largeur/2)|0)),(this.m_y+((this.m_hauteur/2)|0)),0.5,0.5);
	err_info="C:/Dropbox/Programmes/Test.monkey<236>";
	pop_err();
	return 0;
}
var bb_Test_txtinformation="";
function c_AngelFontExample(){
	Object.call(this);
}
c_AngelFontExample.m_new=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Test.monkey<128>";
	pop_err();
	return this;
}
...
function bbInit(){
	...
	bb_Test_txtinformation="";
	bb_Test_numeroDuFond=0;
}
//${TRANSCODE_END}
