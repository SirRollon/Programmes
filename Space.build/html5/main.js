...
//${METADATA_BEGIN}
var META_DATA="[Anim1.png];type=image/png;width=173;height=87;\n[bouton.png];type=image/png;width=100;height=30;\n[bureau.jpg];type=image/jpg;width=740;height=467;\n[galaxie.jpg];type=image/jpg;width=1024;height=768;\n[monkey64.png];type=image/png;width=128;height=128;\n[mojo_font.png];type=image/png;width=864;height=13;\n";
//${METADATA_END}
...
c_MyApp.m_new=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<13>";
...
c_MyApp.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<25>";
	bb_app_SetUpdateRate(60);
	err_info="C:/Dropbox/Programmes/Space.monkey<28>";
	this.m_start=c_Bouton.m_new.call(new c_Bouton);
	err_info="C:/Dropbox/Programmes/Space.monkey<29>";
	dbg_object(this.m_start).m_x=150;
	err_info="C:/Dropbox/Programmes/Space.monkey<30>";
	dbg_object(this.m_start).m_y=150;
	err_info="C:/Dropbox/Programmes/Space.monkey<31>";
	this.m_start.p_OnCreate();
	err_info="C:/Dropbox/Programmes/Space.monkey<34>";
	this.m_score=c_Affichage.m_new.call(new c_Affichage);
	err_info="C:/Dropbox/Programmes/Space.monkey<35>";
	dbg_object(this.m_score).m_x=300;
	err_info="C:/Dropbox/Programmes/Space.monkey<36>";
	dbg_object(this.m_score).m_y=300;
	err_info="C:/Dropbox/Programmes/Space.monkey<37>";
	this.m_score.p_OnCreate();
	err_info="C:/Dropbox/Programmes/Space.monkey<38>";
	dbg_object(this.m_score).m_texte="SCORE";
	err_info="C:/Dropbox/Programmes/Space.monkey<39>";
	dbg_object(this.m_score).m_infobulle=true;
	err_info="C:/Dropbox/Programmes/Space.monkey<42>";
	this.m_information=c_Affichage.m_new.call(new c_Affichage);
	err_info="C:/Dropbox/Programmes/Space.monkey<43>";
	dbg_object(this.m_information).m_x=0;
	err_info="C:/Dropbox/Programmes/Space.monkey<44>";
	dbg_object(this.m_information).m_y=0;
	err_info="C:/Dropbox/Programmes/Space.monkey<45>";
	this.m_information.p_OnCreate();
	err_info="C:/Dropbox/Programmes/Space.monkey<46>";
	dbg_object(this.m_information).m_texte=bb_Space_txtinformation;
	err_info="C:/Dropbox/Programmes/Space.monkey<49>";
	this.m_fond=bb_graphics_LoadImage("galaxie.jpg",1,c_Image.m_DefaultFlags);
	err_info="C:/Dropbox/Programmes/Space.monkey<50>";
	this.m_fond2=bb_graphics_LoadImage("bureau.jpg",1,c_Image.m_DefaultFlags);
	err_info="C:/Dropbox/Programmes/Space.monkey<51>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<56>";
	this.m_start.p_OnUpdate();
	err_info="C:/Dropbox/Programmes/Space.monkey<57>";
	this.m_score.p_OnUpdate();
	err_info="C:/Dropbox/Programmes/Space.monkey<58>";
	dbg_object(this.m_information).m_texte=bb_Space_txtinformation;
	err_info="C:/Dropbox/Programmes/Space.monkey<59>";
	this.m_information.p_OnUpdate();
	err_info="C:/Dropbox/Programmes/Space.monkey<61>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<67>";
	bb_graphics_Cls(0.0,0.0,0.0);
	err_info="C:/Dropbox/Programmes/Space.monkey<68>";
	if(bb_Space_numeroDuFond==1){
		err_info="C:/Dropbox/Programmes/Space.monkey<69>";
		bb_graphics_DrawImage(this.m_fond,0.0,0.0,0);
	}
	err_info="C:/Dropbox/Programmes/Space.monkey<72>";
	if(bb_Space_numeroDuFond==2){
		err_info="C:/Dropbox/Programmes/Space.monkey<73>";
		bb_graphics_DrawImage(this.m_fond2,0.0,0.0,0);
	}
	err_info="C:/Dropbox/Programmes/Space.monkey<76>";
	this.m_start.p_OnRender();
	err_info="C:/Dropbox/Programmes/Space.monkey<77>";
	this.m_score.p_OnRender();
	err_info="C:/Dropbox/Programmes/Space.monkey<78>";
	this.m_information.p_OnRender();
	err_info="C:/Dropbox/Programmes/Space.monkey<80>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnLoading=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<85>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnSuspend=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<97>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnResume=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<102>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnClose=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<107>";
	c_App.prototype.p_OnClose.call(this);
	err_info="C:/Dropbox/Programmes/Space.monkey<108>";
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnBack=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<113>";
	c_App.prototype.p_OnBack.call(this);
	err_info="C:/Dropbox/Programmes/Space.monkey<114>";
	pop_err();
	return 0;
}
...
var bb_Space_theApp=null;
function bbMain(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<8>";
	bb_Space_theApp=c_MyApp.m_new.call(new c_MyApp);
	err_info="C:/Dropbox/Programmes/Space.monkey<9>";
	pop_err();
	return 0;
}
...
c_Bouton.m_new=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<119>";
	pop_err();
	return this;
}
c_Bouton.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<129>";
	this.m_bouton=bb_graphics_LoadImage("bouton.png",1,c_Image.m_DefaultFlags);
	err_info="C:/Dropbox/Programmes/Space.monkey<131>";
	pop_err();
	return 0;
}
c_Bouton.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<137>";
	var t_hit=bb_input_KeyHit(1);
	err_info="C:/Dropbox/Programmes/Space.monkey<139>";
	if(t_hit==1){
		err_info="C:/Dropbox/Programmes/Space.monkey<140>";
		print("X ="+String(this.m_x)+"Y="+String(this.m_y));
	}
	err_info="C:/Dropbox/Programmes/Space.monkey<143>";
	if(((t_hit)!=0) && bb_input_MouseY()>(this.m_y) && bb_input_MouseY()<(this.m_y+this.m_hauteur) && bb_input_MouseX()>(this.m_x) && bb_input_MouseX()<(this.m_x+this.m_largeur)){
		err_info="C:/Dropbox/Programmes/Space.monkey<144>";
		print("clic sur le bouton"+bb_Space_txtinformation);
		err_info="C:/Dropbox/Programmes/Space.monkey<145>";
		bb_Space_txtinformation="clic sur le bouton";
		err_info="C:/Dropbox/Programmes/Space.monkey<147>";
		bb_Space_numeroDuFond=1;
		err_info="C:/Dropbox/Programmes/Space.monkey<150>";
		print("numeroDuFond = "+String(bb_Space_numeroDuFond));
	}
	err_info="C:/Dropbox/Programmes/Space.monkey<152>";
	pop_err();
	return 0;
}
c_Bouton.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<158>";
	bb_graphics_DrawImage(this.m_bouton,(this.m_x+((this.m_largeur/2)|0)),(this.m_y+((this.m_hauteur/2)|0)),0);
	err_info="C:/Dropbox/Programmes/Space.monkey<160>";
	pop_err();
	return 0;
}
function c_Affichage(){
	Object.call(this);
	this.m_x=0;
	this.m_y=0;
	this.m_texte="Affichage";
	this.m_infobulle=false;
	this.m_hauteur=32;
	this.m_largeur=64;
	this.m_survol=false;
}
c_Affichage.m_new=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<164>";
	pop_err();
	return this;
}
c_Affichage.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<174>";
	pop_err();
	return 0;
}
c_Affichage.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<179>";
	if(this.m_infobulle){
		err_info="C:/Dropbox/Programmes/Space.monkey<181>";
		if(bb_input_MouseY()>(this.m_y) && bb_input_MouseY()<(this.m_y+this.m_hauteur) && bb_input_MouseX()>(this.m_x) && bb_input_MouseX()<(this.m_x+this.m_largeur)){
			err_info="C:/Dropbox/Programmes/Space.monkey<182>";
			bb_Space_txtinformation="survol du score, afficher des infos";
			err_info="C:/Dropbox/Programmes/Space.monkey<183>";
			print("survol");
			err_info="C:/Dropbox/Programmes/Space.monkey<184>";
			this.m_survol=true;
			err_info="C:/Dropbox/Programmes/Space.monkey<185>";
			bb_Space_numeroDuFond=2;
		}
	}
	err_info="C:/Dropbox/Programmes/Space.monkey<188>";
	pop_err();
	return 0;
}
c_Affichage.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Dropbox/Programmes/Space.monkey<193>";
	bb_graphics_SetColor(255.0,255.0,0.0);
	err_info="C:/Dropbox/Programmes/Space.monkey<194>";
	bb_graphics_DrawRect((this.m_x),(this.m_y),(this.m_largeur),(this.m_hauteur));
	err_info="C:/Dropbox/Programmes/Space.monkey<195>";
	bb_graphics_DrawText(this.m_texte,(this.m_x+((this.m_largeur/2)|0)),(this.m_y+((this.m_hauteur/2)|0)),0.5,0.5);
	err_info="C:/Dropbox/Programmes/Space.monkey<196>";
	pop_err();
	return 0;
}
var bb_Space_txtinformation="";
...
function bbInit(){
	...
	bb_Space_txtinformation="";
	bb_Space_numeroDuFond=0;
}
//${TRANSCODE_END}
